...
module cube_bottom() {
    ...
    cube([1,.4,cube_thickness]);
    cube([.4,1,cube_thickness]);
...
module cube_top() {
    ...
    translate([1-.4, 1-cube_thickness, 1-.4]) cube([.4, cube_thickness, .4]);
    translate([1-.4, 1-.4, 1-cube_thickness]) cube([.4, .4, cube_thickness]);
}
